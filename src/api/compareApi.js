...
export const COMPARE_METRIC_GROUPS = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { key: 'fc_market_borrowings', metricId: 220, label: 'Market Borrowings — Gross Raised (₹)', unit: 'amount' },
      { key: 'fc_market_borrowings_repayments', metricId: 333, label: 'Market Borrowings — Repayments (₹)', unit: 'amount' },
      // Table 176 — sub-components of Outstanding Liabilities (metric 218)
      { key: 'fc_liabilities_sdl', metricId: 334, label: 'Outstanding Liabilities — SDL (₹)', unit: 'amount' },
      { key: 'fc_liabilities_power_bonds', metricId: 335, label: 'Outstanding Liabilities — Power Bonds (₹)', unit: 'amount' },
      { key: 'fc_liabilities_compensation_bonds', metricId: 336, label: 'Outstanding Liabilities — Compensation & Other Bonds (₹)', unit: 'amount' },
      { key: 'fc_liabilities_nssf', metricId: 337, label: 'Outstanding Liabilities — NSSF (₹)', unit: 'amount' },
      { key: 'fc_liabilities_wma_rbi', metricId: 338, label: 'Outstanding Liabilities — WMA from RBI (₹)', unit: 'amount' },
      { key: 'fc_liabilities_loans_lic', metricId: 339, label: 'Outstanding Liabilities — Loans from LIC (₹)', unit: 'amount' },
      { key: 'fc_liabilities_loans_gic', metricId: 340, label: 'Outstanding Liabilities — Loans from GIC (₹)', unit: 'amount' },
      { key: 'fc_liabilities_loans_nabard', metricId: 341, label: 'Outstanding Liabilities — Loans from NABARD (₹)', unit: 'amount' },
      { key: 'fc_liabilities_loans_sbi', metricId: 342, label: 'Outstanding Liabilities — Loans from SBI & Other Banks (₹)', unit: 'amount' },
      { key: 'fc_liabilities_loans_ncdc', metricId: 343, label: 'Outstanding Liabilities — Loans from NCDC (₹)', unit: 'amount' },
      { key: 'fc_liabilities_loans_other_institutions', metricId: 344, label: 'Outstanding Liabilities — Loans from Other Institutions (₹)', unit: 'amount' },
      { key: 'fc_liabilities_loans_banks_fis', metricId: 345, label: 'Outstanding Liabilities — Loans from Banks & FIs, Total (₹)', unit: 'amount' },
      { key: 'fc_liabilities_total_internal_debt', metricId: 346, label: 'Outstanding Liabilities — Total Internal Debt (₹)', unit: 'amount' },
      { key: 'fc_liabilities_loans_centre', metricId: 347, label: 'Outstanding Liabilities — Loans & Advances from Centre (₹)', unit: 'amount' },
      { key: 'fc_liabilities_provident_fund', metricId: 348, label: 'Outstanding Liabilities — Provident Fund (₹)', unit: 'amount' },
      { key: 'fc_liabilities_reserve_funds', metricId: 349, label: 'Outstanding Liabilities — Reserve Funds (₹)', unit: 'amount' },
      { key: 'fc_liabilities_deposits_advances', metricId: 350, label: 'Outstanding Liabilities — Deposits & Advances (₹)', unit: 'amount' },
      { key: 'fc_liabilities_contingency_funds', metricId: 351, label: 'Outstanding Liabilities — Contingency Funds (₹)', unit: 'amount' },
    ],
  },
  {
    groupLabel: 'Health',
